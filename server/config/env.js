...
module.exports = {
  ...
  ZEGO_APP_ID: process.env.ZEGO_APP_ID || process.env.ZEGO_WEB_APP_ID || process.env.ZEGO_APPP_ID || process.env.ZEGOCLOUD_APP_ID || '',
  ZEGO_APP_ID_2: process.env.ZEGO_APP_ID_2 || process.env.ZEGO_MOBILE_APP_ID || process.env.ZEGO_SERVER_APP_ID || '',
  ZEGO_SERVER_SECRET: process.env.ZEGO_SERVER_SECRET || process.env.ZEGOCLOUD_SERVER_SECRET || '',
  ZEGO_APP_SIGN: process.env.ZEGO_APP_SIGN || process.env.ZEGO_SERVER_SING || process.env.ZEGO_SERVER_SIGN || process.env.ZEGOCLOUD_APP_SIGN || '',
  ZEGO_APP_SIGN_2: process.env.ZEGO_APP_SIGN_2 || process.env.ZEGO_MOBILE_APP_SIGN || ''
};
